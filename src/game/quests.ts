...
export const QUEST_CHAIN: Quest[] = [
  {
    id: 'first-roots',
    name: 'First Roots',
    blurb: 'Every farm starts with turned soil.',
    objectives: [
  ...
  },
  {
    id: 'first-harvest',
    name: 'First Harvest',
    blurb: 'Water them and wait. Rain will do the job for you.',
    objectives: [
      { kind: 'water', target: 4, label: 'Water 4 plots' },
  ...
  },
  {
    id: 'market-day',
    name: 'Market Day',
    blurb: 'The stall by the path buys anything you grow.',
  ...
  },
  {
    id: 'room-to-grow',
    name: 'Room to Grow',
    blurb: 'Take out the shovel and claim more ground.',
  ...
  },
  {
    id: 'carrot-top',
    name: 'Carrot Top',
    blurb: 'Roots that pay better than turnips.',
  ...
  },
  {
    ...
    blurb: 'Leave a crop out through rain or a moonlit night and see what happens.',
  ...
  },
  {
    id: 'golden-fields',
    name: 'Golden Fields',
    blurb: 'Corn takes its time but pays for the patience.',
  ...
  },
  {
    id: 'struck-lucky',
    name: 'Struck Lucky',
    blurb: 'Silver or better. Plant enough and the odds come to you.',
  ...
  },
  {
    id: 'coin-purse',
    name: 'Full Coffers',
    blurb: 'Save up. The best seeds are not cheap.',
  ...
  },
  {
    id: 'melon-baron',
    name: 'Melon Baron',
    blurb: 'Two melons per plot, every plot.',
    objectives: [
  ...
  {
    id: 'sunflower-estate',
    name: 'Sunflower Estate',
    blurb: 'The tallest crop in the valley.',
  ...
  },
  {
    ...
    blurb: 'One in fifty, if the luck holds.',
  ...
  },
  {
    id: 'dragons-hoard',
    name: "Dragon's Hoard",
    blurb: 'The last and richest crop in the valley.',
    objectives: [
